rm(list = ls())
##############Plot the Graph for Figure 4
load("Simulated Data for Main Analyses/Simulatin_02_main_output.RData")
...
write.csv(temp, "simulation 2 table.csv")
...
axis(1, 1:5, c("", "250 (Quota = 2)", "500 (Quota = 4)", 
               "750 (Quota = 7)", "1000 (Quota = 10)"), col.axis = "blue")
