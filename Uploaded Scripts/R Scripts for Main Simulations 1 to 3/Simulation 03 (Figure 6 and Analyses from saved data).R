rm(list = ls())
##############Plot the Graph for Figure 6
load("Simulated Data for Main Analyses/Simulatin_03_main_output.RData")
...
write.csv(temp, "simulation 3 table.csv")
...
axis(1, 1:5, c("", "250 (Quota = 2)", "500 (Quota = 10)", 
               "750 (Quota = 7)", "1000 (Quota = 2)"), col.axis = "blue")
