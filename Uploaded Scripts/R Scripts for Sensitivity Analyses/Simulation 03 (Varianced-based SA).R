...
save(y, file = "Simulated Data for Sensitivity Analyses/study 3 sensobol_y.RData")
save(out, file = "Simulated Data for Sensitivity Analyses/study 3 sensobol_out.RData")
